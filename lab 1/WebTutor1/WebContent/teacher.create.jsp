...
<img src="images\校徽.jpg" width="70" height="70" />
	...
	<h3 align="right"><a href="index(2).jsp">退出</a></h3>
...
<div id="inform">
			...
			<form action="#" method="post">
				...
				<input type="text" Name="classgrade" placeholder="年级" required="">
				...
				<input type="text" Name="QQnumber" placeholder="QQ号码" required="">
